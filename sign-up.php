...
<body>
<center><font color="gray">/* Эта строка служит только для наглядности */ Незалогиненный пользователь</font> | <a href="logged_in.php" title="" target="">Залогиненный пользователь</a> <font color="gray">/* Эта строка служит только для наглядности */</font></center>
...
<OPTION>中文</OPTION>
</SELECT> Sign-up | <a href="login.php" target="" title="">Login</a> | <a href="support.php" target="" title="">Help</a> <button title="Зарегистрироваться как человек ищущий общение">Хочу найти общение</button></td>
</tr>
</table>

<br><br><br><br>

<center>E-mail <input> Password <input> Repeat password, please <input> <button>Send</button></center>
